...
cursor.execute(
   """select count(name) from sqlite_master where type='table' and name='doctor'""")
...
cursor.execute(
   """select count(name) from sqlite_master where type='table' and name='patient'""")
    ...
    while e != 0:
        ...
        if e == 2:
            ...
            while error == 1:
                ...
                cursor.execute(
                   """select count(d_id) from doctor where d_id=(?)""", (i,))
                if cursor.fetchone()[0] == 1:
                    cursor.execute(
                       """select count(password) from doctor where password=?""", (p,))
                    if cursor.fetchone()[0] == 1:
                        print("\nSign in successful!")
                        screen_clear()
                        error = 0
                        ...
                        cursor.execute(
                           """select d_id,dnamedfirst,dnamedlast,speciality,shift,phone from doctor where d_id=(?)""", (i,))

                        for row in cursor.fetchall():
                           print("ID -", row[0], "  Name -", row[1], row[2], "  Speciality -",
                        ...
                        while r != 0:
                           ...
                           if r == 1:
                              access = input("\nEnter Patient ID:- ")
                              cursor.execute(
                                 """select count(*) from patient where p_id=(?)""", (access,))
                              if cursor.fetchone()[0] != 0:
                                 cursor.execute(
                                    """select * from patient where p_id=(?)""", (access,))
                                 print("\nPatient Details - ")
                                 for row in cursor.fetchall():
                                    print("Id: ", row[0])
                                 ...
                                 print("\nDiagnosis Report - ")
                                 cursor.execute(
                                    """select count(*) from virus where p_id=(?)""", (access,))

                                 if cursor.fetchone()[0] != 0:
                                    cursor.execute(
                                       """select * from virus where p_id=(?)""", (access,))
                                 ...
                                 cursor.execute(
                                    """select count(*) from bacteria where p_id=(?)""", (access,))

                                 if cursor.fetchone()[0] != 0:
                                    cursor.execute(
                                       """select * from bacteria where p_id=(?)""", (access,))
                                 ...
                                 cursor.execute(
                                    """select count(*) from injury where p_id=(?)""", (access,))

                                 if cursor.fetchone()[0] != 0:
                                    cursor.execute(
                                       """select * from injury where p_id=(?)""", (access,))
                                    for row in cursor.fetchall():
                                       print("Id: ", row[0])
                              ...
                              if m == 1:
                                 ...
                                 cursor.execute(
                                    """insert into virus values(?,?,?,?,?)""", (pid, dname, bname, treatment, symptoms))
                                 ...
                                 symptoms = input("Enter symptoms - ")
                                 cursor.execute(
                                    """insert into bacteria values(?,?,?,?,?)""", (pid, dname, bname, treatment, symptoms))
                                 ...
                                 cursor.execute(
                                    """insert into injury values(?,?,?,?)""", (pid, iname, idiag, itype))
                              ...
                              if cursor.fetchone()[0] != 0:
                                 cursor.execute(
                                    """delete from patient where p_id=(?)""", (access,))
                                 cursor.execute(
                                    """select count(*) from virus where p_id=(?)""", (access,))

                                 if cursor.fetchone()[0] != 0:
                                    cursor.execute(
                                       """delete from virus where p_id=(?)""", (access,))
                                 ...
                                 if cursor.fetchone()[0] != 0:
                                    cursor.execute(
                                       """delete from bacteria where p_id=(?)""", (access,))
                                 ...
                                 if cursor.fetchone()[0] != 0:
                                    cursor.execute(
                                       """delete from injury where p_id=(?)""", (access,))
                              else:
                                 print(
                                    "Incorrect Patient id Patient does not exist")
